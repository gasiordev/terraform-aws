...
module "aws_vpc_peering_requester_stag_mgmt" {
  ...
  vpc_id                      = module.aws_vpc_stag.vpc_attributes.vpc_id
  ...
  route_table_public          = module.aws_vpc_stag.vpc_attributes.route_table_id.public
  route_table_private_a       = module.aws_vpc_stag.vpc_attributes.route_table_id.private.a
  route_table_private_b       = module.aws_vpc_stag.vpc_attributes.route_table_id.private.b
  route_table_private_c       = module.aws_vpc_stag.vpc_attributes.route_table_id.private.c
...
module "aws_vpc_peering_accepter_stag_mgmt" {
  ...
  cidr_block                 = module.aws_vpc_stag.vpc_attributes.cidr_block
